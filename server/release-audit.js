...
export function auditReleaseReadiness() {
  ...
  requireCondition(
    ControlsSource.includes('export function classifyLandedPointerStart(')
      ...
      && PresentationSource.includes('export function getPlantedCageWorldPlacement(')
      && HostileSurfaceSource.includes('listHostileCageSites(')
      && WardenVisualsSource.includes('getPlantedCageWorldPlacement(')
  ...
  requireCondition(
    PresentationSource.includes('export function getHowToPlayPresentation(')
      ...
      && PresentationSource.includes('Drag the ground to walk around this little world. Q and E walk the rim; T and F walk the poles.')
      && PresentationSource.includes('Pull the ship and let go to fly. A and D steer; W and S change power.')
      && PresentationSource.includes('Land on another world to link it.')
      && PresentationSource.includes('If you see a red cage, walk up to it and tap it to smash it.')
      && PresentationSource.includes('Drag empty space to look around. C opens Scout. Escape pauses.')
      && PresentationSource.includes('Finish by landing on the moving Command World.')
  ...
  requireCondition(
    AuthoredSystemDefinitions[DefaultAuthoredSystemIdentifier]
      ...
      && HudSource.includes('getLoopObjectivePresentation(')
      && PresentationSource.includes('Drag the ground to walk around this little world.')
      && PresentationSource.includes('Pull the ship and let go to fly. If a red cage is in the way, tap it.')
      && HudSource.includes('getFirstRunCoachPresentation(')
      && HudSource.includes('FirstRunCoachBodies')
