...
3. **Destroy** — occupied unrestored worlds spawn a tappable equatorial cage on dock. Grove, Ember and Bastion keep authored rim cages. The landed close-up frames the rim so those cages stay visible and tappable. The cage banner only appears while a cage is actually up.
