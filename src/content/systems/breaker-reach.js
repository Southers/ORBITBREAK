...
export const BreakerReachSystemDefinition = {
  ...
  openingBody: 'Link a world and it wakes: lights, people, trade.',
  openingBriefing: [
    {
      speaker: 'THE WARDEN',
      ...
      body: 'Stay on your world. Do not fly. Do not talk to a neighbour. Connection is disorder. I hunt anyone who links a world.',
    },
    {
      speaker: 'THE RUNNER',
      ...
      body: 'I fly the Orbitbreaker between tiny worlds. Land, walk, then launch to the next one. Linking worlds wakes them: lights, people, trade. Occupied worlds have cages. Swipe from the ship through a cage to break it. The Warden hunts connection.',
    },
  ],
  storyBoards: {
    firstAnswer: {
      ...
      pages: [
        {
          ...
          body: 'You landed. We are linked. The furnaces are lit, people are out, and a barge is loading. That is what connection does.',
        },
        {
          speaker: 'THE RUNNER',
      ...
      pages: [
        {
          ...
          body: 'You opened the watch. Walk the rim. Swipe from the ship through a cage to break it, then launch.',
        },
      ],
    },
    firstSpindle: {
    ...
    commandExposed: {
      ...
      pages: [
        ...
        },
        {
          ...
          body: 'Track it. Land. Walk the rim. Swipe from the ship through the cage. The Reach will answer together.',
        },
      ],
    },
    commandApproach: {
      ...
      pages: [
        {
          ...
          body: 'Grab the ship. Drag through the bars. One swipe is enough.',
        },
      ],
    },
    reachAnswers: {
